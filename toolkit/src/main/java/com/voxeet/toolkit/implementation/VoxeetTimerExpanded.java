...
public class VoxeetTimerExpanded extends VoxeetView {
     ...
     */
    public VoxeetTimerExpanded(Context context) {
        super(context);
    }
     ...
     */
    public VoxeetTimerExpanded(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public VoxeetTimerExpanded(Context context, AttributeSet attrs, int defStyleAttr) {
